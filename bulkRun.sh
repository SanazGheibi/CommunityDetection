...
#./CE_Louvain_V5_StructuralPrune/community ~/Louvain_input/"RandomShuffle_${name}.bin" -c $cache -l -1 -v -q 0.0001 > ./CE_Louvain_V5_StructuralPrune/graph.tree 2> "./CE_Louvain_V5_StructuralPrune/${name}_res.txt"
