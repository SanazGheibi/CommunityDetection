...
(sanaz): an item -a is also added to adjust alpha: the multiple for the 
window size (W). The default for alpha is 1.0
./community graph.bin -l -1 -v -q 0.0001 -a 0.8 > graph.tree
